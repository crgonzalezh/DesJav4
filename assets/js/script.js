const propiedades_venta = [
        ...
        <div class="col-md-4 mb-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p><i class="fas fa-bed"></i> ${property.habitaciones} Habitaciones | <i class="fas fa-bath"></i> ${property.bathrooms} Baños</p>
              ...
              ${property.pets ? '<p class="text-success"><i class="fas fa-paw"></i> Mascotas permitidas</p>' : '<p class="text-danger"><i class="fas fa-ban"></i> No se permiten mascotas</p>'}
            </div>
          </div>
        </div>
      `;
  ...
  document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('venta')) {
      renderProperties(propiedades_venta, 'venta');
    }
    if (document.getElementById('alquiler')) {
      renderProperties(propiedades_alquiler, 'alquiler');
    }
  });
